/* Directions:
Write a fn that accepts a positive number N. The fn should console.log() a step shape w/ N levels using the # char. Make sure the step has spaces on the right hand side! Note: N implies the number of lines
